...
const CL02Calendar = () => {
    ...
    // Fetch booked slots for CL02
    useEffect(() => {
        fetch("http://localhost:5000/api/locations/CL02")  // Fetching data for CL02
            .then((res) => res.json())
    ...
    return (
        <div className="calendar-container">
            <h1>Booking Calendar for Software Lab 2 (CL02)</h1>
            <Calendar
